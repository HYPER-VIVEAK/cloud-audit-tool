        ...
        <Grid.Col span={{ base: 12, sm: 6 }}>
          <Card withBorder shadow="sm">
            <Stack gap="sm">
              ...
              {isError && <Alert color="red" icon={<IconAlertCircle size={16} />}>Could not load scan summary</Alert>}
              {!isLoading && !isError && !hasAnalysis && (
                <Alert color="blue" icon={<IconAlertCircle size={16} />}>No scan results yet. Run your first scan.</Alert>
              )}
              {!isLoading && !isError && hasAnalysis && (
